...
using KpzRepository.Sqlite.Tests.Model;
...
public class TableWithStringIdTests
{
    ...
    public void GetRepositoryTableName_ShouldReturnCorrectTableName()
    {
        ...
        Assert.That(tableName, Is.EqualTo(nameof(table_with_string_id)));
    }
    ...
    public void GetLastInsertedId_ShouldReturnLastId()
    {
        ...
        // For string IDs with ExplicitKey, we know the last inserted id is the one we set
        var lastId = "LAST_ID_TEST";
