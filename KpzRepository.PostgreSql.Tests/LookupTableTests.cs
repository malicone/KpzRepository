...
public class LookupTableTests
{
    ...
    {
        var entity = new LookupTable();
        Assert.That(entity.GetTableName(), Is.EqualTo("lookup_table"));
    }
    ...
    {
        var entity = new LookupTable();
        Assert.That(entity.IsFieldTypeOfString("name"), Is.False); // Case matters in C#
        Assert.That(entity.IsFieldTypeOfString("NAME"), Is.False);
    }
